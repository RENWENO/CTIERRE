...
class GraphConvolution(nn.Module):
    ...
    def __init__(self, in_features, out_features, bias=True):
        ...
        #nn.Parameter()Customize the parameters you want to learn. torch.FloatTensor(in,out) builds a tensor of type float of size (in,out).
    ...
    def reset_parameters(self):#initialization parameter
    ...
    def forward(self, text, adj):
        #torch.matmul()Multiply two tensors together
...
#Relational network attention mechanism
...
#Calculate the attention between words and relationships
class GAT_relation(nn.Module):
    ...
    def forward(self, x, p, mask=None):
        # Calculate the attention of words and relationships
        x_ = self.ra1(x, p)
        x = x_ + x
        # Calculate relationships and word attention
